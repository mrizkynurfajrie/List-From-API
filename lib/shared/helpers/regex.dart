...
int getNumberFromString(String value) {
...
bool isValidPassword({required String password, int minLength = 6}) {
  ...
  return
      // capitalFirst &&
      hasLowercase && hasMinLength;
  //  &&
  // hasSpecialCharacters;
}

bool isValidNominal({required String nominal, int minNominal = 20000}) {
  if (nominal.isEmpty) {
    return false;
  }

  bool hasMinNominal = int.parse(nominal) >= minNominal;
